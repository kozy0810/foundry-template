...
install :; forge install rari-capital/solmate && forge install foundry-rs/forge-std && forge install marktoda/forge-gas-snapshot && forge install Arachnid/solidity-stringutils
